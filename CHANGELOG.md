...
- connectionKey property missing from Message class [\#499](https://github.com/ably/ably-dotnet/issues/499)
- Fail connection immediately if authorize\(\) called and 403 returned [\#448](https://github.com/ably/ably-dotnet/issues/448)
- Upgrade FluentAssertions, fluentassertions.json to 5.x [\#436](https://github.com/ably/ably-dotnet/issues/436)

**Merged pull requests:**

- Address possible 'NullReferenceException's. [\#589](https://github.com/ably/ably-dotnet/pull/589) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Remove project references to deleted 'nuspec' file. [\#588](https://github.com/ably/ably-dotnet/pull/588) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Remove msgpack nuspec [\#585](https://github.com/ably/ably-dotnet/pull/585) ([marto83](https://github.com/marto83))
- Rename 'ConnectionStateBase' file name to match type name. [\#584](https://github.com/ably/ably-dotnet/pull/584) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Fix 'MockBackGroundService' class not used. [\#583](https://github.com/ably/ably-dotnet/pull/583) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Fix missing 'readonly'-ness [\#582](https://github.com/ably/ably-dotnet/pull/582) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Remove redundant type cast. [\#581](https://github.com/ably/ably-dotnet/pull/581) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Specify string culture explicitly [\#580](https://github.com/ably/ably-dotnet/pull/580) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Fix class is never instantiated. [\#578](https://github.com/ably/ably-dotnet/pull/578) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Rename file name to match type name. [\#577](https://github.com/ably/ably-dotnet/pull/577) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Abstract ctors should be protected, not public. [\#575](https://github.com/ably/ably-dotnet/pull/575) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Remove redundant empty ctor arg list. [\#574](https://github.com/ably/ably-dotnet/pull/574) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Local function can be static. [\#572](https://github.com/ably/ably-dotnet/pull/572) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Class is never instanciated. [\#571](https://github.com/ably/ably-dotnet/pull/571) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Fix public docs for 'AsyncLazy'. [\#570](https://github.com/ably/ably-dotnet/pull/570) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Remove unused 'FakeHttpClient' type [\#569](https://github.com/ably/ably-dotnet/pull/569) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Fix warning for unassigned variable created by new. [\#568](https://github.com/ably/ably-dotnet/pull/568) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Remove redundant type in array creation [\#567](https://github.com/ably/ably-dotnet/pull/567) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Remove redundant empty ctor [\#566](https://github.com/ably/ably-dotnet/pull/566) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Remove redundant ctor overload. [\#565](https://github.com/ably/ably-dotnet/pull/565) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Abstract classes should have protected ctors. [\#564](https://github.com/ably/ably-dotnet/pull/564) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Fix typos in APIs, comments and string literals [\#563](https://github.com/ably/ably-dotnet/pull/563) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Remove unused member state. [\#562](https://github.com/ably/ably-dotnet/pull/562) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Remove redundant 'ToString' calls. [\#561](https://github.com/ably/ably-dotnet/pull/561) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Add heartbeat monitor [\#560](https://github.com/ably/ably-dotnet/pull/560) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Remove redundant parenthesis in ctor expressions. [\#558](https://github.com/ably/ably-dotnet/pull/558) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Fix Push API documentation. [\#557](https://github.com/ably/ably-dotnet/pull/557) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Fix possible null reference exception. [\#556](https://github.com/ably/ably-dotnet/pull/556) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Make 'WaitingForAck' field 'readonly' [\#555](https://github.com/ably/ably-dotnet/pull/555) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Push interface activate methods [\#554](https://github.com/ably/ably-dotnet/pull/554) ([marto83](https://github.com/marto83))
- Implement intent logic [\#553](https://github.com/ably/ably-dotnet/pull/553) ([marto83](https://github.com/marto83))
- Add Transition logic for State After Registration Sync failed [\#552](https://github.com/ably/ably-dotnet/pull/552) ([marto83](https://github.com/marto83))
- Waiting for Registration Sync State - Add Transition logic [\#551](https://github.com/ably/ably-dotnet/pull/551) ([marto83](https://github.com/marto83))
- Remove redundant 'using' statements [\#550](https://github.com/ably/ably-dotnet/pull/550) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Fix possible null assignment to null-nullable entity [\#549](https://github.com/ably/ably-dotnet/pull/549) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Implement waiting for deregistration [\#548](https://github.com/ably/ably-dotnet/pull/548) ([marto83](https://github.com/marto83))
- Add Transition logic for WaitingForPushDeviceDetails State [\#547](https://github.com/ably/ably-dotnet/pull/547) ([marto83](https://github.com/marto83))
- Feature/push/statemachine getregistrationtoken [\#546](https://github.com/ably/ably-dotnet/pull/546) ([marto83](https://github.com/marto83))
- Make 'MessageToSend' struct 'readonly' [\#545](https://github.com/ably/ably-dotnet/pull/545) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Fix internal method name spelling. [\#544](https://github.com/ably/ably-dotnet/pull/544) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Port the code for HandleEvent from the java sdk [\#543](https://github.com/ably/ably-dotnet/pull/543) ([marto83](https://github.com/marto83))
- Activation State Machine - NotActivated State and Transition [\#542](https://github.com/ably/ably-dotnet/pull/542) ([marto83](https://github.com/marto83))
- Remove unused 'AblyAuthUpdatedEventArgs' type [\#541](https://github.com/ably/ably-dotnet/pull/541) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Remove the unused 'MimeTypes. [\#540](https://github.com/ably/ably-dotnet/pull/540) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Add State machine and available events. [\#539](https://github.com/ably/ably-dotnet/pull/539) ([marto83](https://github.com/marto83))
- Fix API Doc Comment Spelling [\#538](https://github.com/ably/ably-dotnet/pull/538) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Feature/push/push admin [\#537](https://github.com/ably/ably-dotnet/pull/537) ([marto83](https://github.com/marto83))
- Fix some typos in string literals. [\#536](https://github.com/ably/ably-dotnet/pull/536) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Use 'static' where possible [\#535](https://github.com/ably/ably-dotnet/pull/535) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Feature/push/infra [\#534](https://github.com/ably/ably-dotnet/pull/534) ([marto83](https://github.com/marto83))
- Refactor connection serial, updated [\#533](https://github.com/ably/ably-dotnet/pull/533) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Fix unused variable [\#532](https://github.com/ably/ably-dotnet/pull/532) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Remove redundant 'using' statements [\#531](https://github.com/ably/ably-dotnet/pull/531) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Add AddRequestId property to ClientOptions [\#530](https://github.com/ably/ably-dotnet/pull/530) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Remove obsolete 'ClientOptions' tests [\#529](https://github.com/ably/ably-dotnet/pull/529) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Remove unused test dependencies [\#528](https://github.com/ably/ably-dotnet/pull/528) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Update readme for spelling and consistency [\#527](https://github.com/ably/ably-dotnet/pull/527) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Disable failing tests [\#525](https://github.com/ably/ably-dotnet/pull/525) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Remove legacy tests [\#521](https://github.com/ably/ably-dotnet/pull/521) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Rename 'IRestChannel' file name to match type [\#518](https://github.com/ably/ably-dotnet/pull/518) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Rename 'AsyncHelper' file to match type name. [\#517](https://github.com/ably/ably-dotnet/pull/517) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Update 'fake-cli' to '5.20.4' [\#516](https://github.com/ably/ably-dotnet/pull/516) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Fix possible 'NullReferenceException' [\#515](https://github.com/ably/ably-dotnet/pull/515) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Rename 'ConnectionDetails' file to match [\#513](https://github.com/ably/ably-dotnet/pull/513) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Stop exported by default, types for COM interop [\#512](https://github.com/ably/ably-dotnet/pull/512) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Add 'heartbeat=true' to the default connection Uri [\#510](https://github.com/ably/ably-dotnet/pull/510) ([tomkirbygreen](https://github.com/tomkirbygreen))
- Upgrade FluentAssertions  [\#490](https://github.com/ably/ably-dotnet/pull/490) ([sacOO7](https://github.com/sacOO7))
- Fail connection on forbidden authz [\#459](https://github.com/ably/ably-dotnet/pull/459) ([sacOO7](https://github.com/sacOO7))
