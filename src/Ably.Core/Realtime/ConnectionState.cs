namespace IO.Ably.Realtime
{
    ...
    {
        /// <summary>A connection object having this state has been initialised but no connection has yet been attempted.</summary>
        Initialized,

        /// <summary>A connection attempt has been initiated.</summary>
        /// <remarks>The connecting state is entered as soon as the library
