...
namespace IO.Ably.Realtime
{
    ...
    /// <remarks>
    /// <para><b>NB!</b> Channel doesn't retain the handlers, internally, it uses weak references. This mean you must retain the handlers yourself.</para>
    ...
    {
        readonly Action<Message> action;
