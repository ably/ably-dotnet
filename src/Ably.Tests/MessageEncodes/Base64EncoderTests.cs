...
namespace Ably.Tests.MessageEncodes
{
    public class Base64EncoderTests
    {
        ...
        public class Decode :Base64EncoderTests
        {
            ...
            {
                var payload = new MessagePayload() {data = _base64Data, encoding = "base64"};
            ...
            {
                var payload = new MessagePayload() { data = _base64Data, encoding = "utf-8/base64" };
            ...
            {
                var payload = new MessagePayload() {data = _stringData, encoding = "utf-8"};
        ...
        public class EncodeWithTextProtocol : Base64EncoderTests
        {
            ...
            {
                var payload = new MessagePayload() {data = _binaryData, encoding = "cipher"};
